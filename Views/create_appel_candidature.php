...
<body>
    <div id="content-app">
        ...
        <div id="create-publication">
            ...
            <form method="post" action="index.php?action=create_appel_candidature" class="create-publication-form">
                ...
                <div class="create-publication-groupefield">
                    <label class="create-publication-label" for="name_publication">Nom de l'appel</label>
                    <input name = "nom_appel" type="text" id="name_publication" class="input">
                    <span class="error"> <?php echo $appel_name_Err ;?></span>
                </div>

                <div class="create-publication-groupefield">
                    <label class="create-publication-label" for="content_publication">Description de l'appel</label>
